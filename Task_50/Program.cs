...
// ================================================================================================
// Вариант 4. Задается порядковый номер элемента.
// Поэлементный перебор массива без count.

// void CheckElementOfArray4(int[,] array)
// {
//     int n = PromptNumber("Введите порядковый номер искомого элемента в массиве: (1, 2, ...): ");
//     if (n > array.GetLength(0) * array.GetLength(1))
//     {
...
//             for (int j = 0; j < array.GetLength(1); j++)
//             {
//                 if (((array.GetLength(1) * i) + (j + 1)) == n) // Скобки для понимания)
//                 {
//                     Console.WriteLine($"Искомый элемент равен: {array[i, j]}");
//                     break;
//                 }
